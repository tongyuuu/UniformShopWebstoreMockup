Public Class Homepage
    Public goalPassed = 0
    Private Sub amtstock_Click(sender As Object, e As EventArgs) Handles amtstock.Click
        Stock.Show()
        Me.Hide()
    End Sub

    Private Sub outstock_Click(sender As Object, e As EventArgs) Handles outstock.Click
        Ostock.Show()
        Me.Hide()
    End Sub

    Private Sub incstock_Click(sender As Object, e As EventArgs) Handles incstock.Click
        Istock.Show()
        Me.Hide()
    End Sub
