Public Class Pstock
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Pback.Click
        Homepage.Show()
        Me.Hide()
    End Sub

    Private Sub backstock_Click(sender As Object, e As EventArgs) Handles backstock.Click
        Stock.Show()
        Me.Hide()
    End Sub
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'creating dropdown menu for forms'
        CreateMenu()
    End Sub
